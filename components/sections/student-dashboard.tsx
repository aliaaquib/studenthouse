  ...
  return (
    <section className="section-frame py-12">
      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_360px]">
        <div>
          <h2 className="text-[22px] font-extrabold leading-[1.4]">Saved apartments</h2>
        ...
        <aside className="grid gap-5 self-start">
          ...
          <div className="rounded-[18px] border border-[var(--border)] bg-[var(--card)] p-5 shadow-[var(--shadow-card)]">
            <h2 className="flex items-center gap-2 text-[18px] font-extrabold"><Settings size={18} color="var(--primary)" /> Profile settings</h2>
